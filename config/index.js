export const config = {
  ...
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "2a34880c6f53db2494d4421b524ef217",
  ...
  USERS: [
    {
      ...
      id: "oBsHp5z__5TU6cLfBPiVlf4GgS88",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: " AhGXJU2JtjCKl44MQ6htVEmZFHsiS5BSFu6cw32GzRk",
      // 所在省份
      province: "浙江",
      // 所在城市
      city: "杭州",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "婕婕公主", "year": "2003", "date": "10-29"},
        {"type": "节日", "name": "在一起多久", "year": "2020", "date": "06-13"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {"type": "生日", "name": "焦闻", "year": "1996", "date": "09-31"},
